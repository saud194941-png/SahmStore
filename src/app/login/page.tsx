...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-card/60 backdrop-blur-xl border-border/50 shadow-2xl z-10 relative">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold text-primary">متجر سهم</CardTitle>
          <CardDescription>قم بتسجيل الدخول لبدء أو استكمال محاكاة إمبراطوريتك</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 pt-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="email" type="email" placeholder="name@example.com" className="pl-3 pr-10" />
            </div>
          </div>
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="password" type="password" className="pl-3 pr-10" />
            </div>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">أو الدخول بواسطة</span>
            </div>
          </div>
          
          <Button variant="outline" className="w-full bg-background/50 hover:bg-background">
            <svg viewBox="0 0 24 24" className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" fill="currentColor">
